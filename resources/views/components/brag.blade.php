<div class="lg:px-52 px-2 flex justify-center content-center">
    <a class="mt-5 block p-6 border rounded-md">
        ...
        <p class="text-center text-lightBlue">
            Here, we offer you guidance, and put our best efforts to put you to the right path, one you always wanted to
            pursuit, but lacked support.
            Either you go for studying abroad, or do your dream job, its there, Grub it.
        </p>
    </a>
</div>
