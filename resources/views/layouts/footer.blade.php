<div class="border-x-0 border-y-2 mt-10 border-y-whiteDark bg-offWhite" style="z-index: 1000; position: relative">
    ...
    <div class="pt-4 pb-7 px-4 text-gray-500 md:flex md:items-center md:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            ...
            <a href="{{env('LINKEDIN')}}" target="_blank" class=" hover:text-lightGreen dark:hover:text-white">
            ...
            <a href="{{env('FACEBOOK')}}" target="_blank" class=" hover:text-lightGreen dark:hover:text-white">
            ...
            <a href="{{env('INSTAGRAM')}}" target="_blank" class="hover:text-lightGreen dark:hover:text-white">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fill-rule="evenodd"
            ...
            <a href="{{env('TWITTER')}}" target="_blank" class="hover:text-lightGreen dark:hover:text-white">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path
